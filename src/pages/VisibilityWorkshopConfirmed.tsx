...
const VisibilityWorkshopConfirmed = () => {
  useEffect(() => {
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 sm:p-12 text-center bg-gradient-to-br from-primary/5 to-background border-primary/20">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Your spot for the <strong>How to Win Visibility & Book More Meetings Workshop</strong> is confirmed.
            </p>
              ...
              <div className="space-y-4 text-left max-w-lg mx-auto">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Block your calendar for the workshop at 10:00 AM CST
                    </p>
                  </div>
                </div>
                ...
                <Button
                  ...
                  onClick={() => {
                    trackEvent('Explore Articles Clicked', {
                      from: 'visibility_workshop_confirmation'
                    });
...
export default VisibilityWorkshopConfirmed;
