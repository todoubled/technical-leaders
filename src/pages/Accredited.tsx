  ...
  const leaders = [
    {
      ...
      insight: "The TL Program built a foundation for most of my skills in leadership and helped me clarify my beliefs in software development into an effective leadership style.",
    ...
    },
    {
      ...
      insight: "In a nutshell it's a good recap of all the key competences of an up-to-date Tech Leader.",
      bio: "A transformational technical leader who delivers business impact and has a commercial angle. As a highly experienced and pragmatic technical leader, Miguel excels at driving transformative change within large organizations.",
