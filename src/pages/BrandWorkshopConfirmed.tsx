        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 sm:p-12 text-center bg-gradient-to-br from-primary/5 to-background border-primary/20">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Your spot for the <strong>Build Your Brand Character™ Workshop</strong> is confirmed.
            </p>
              ...
              <div className="space-y-4 text-left max-w-lg mx-auto">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Block your calendar for December 1st, 2025 at 10:00 AM CST
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-muted/50 p-6 rounded-lg mb-8">
              ...
              <Button variant="outline" size="sm" onClick={() => {
                trackEvent('Resend Confirmation Email Clicked', {
                  workshop: 'brand_character_workshop'
                });
                ...
                <Button
                  ...
                  onClick={() => {
                    trackEvent('Explore Articles Clicked', {
                      from: 'brand_workshop_confirmation'
                    });
...
export default BrandWorkshopConfirmed;
