...
const January = () => {
  ...
  useTrackScrollDepth('January Page');
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Prove your offer works and hit $10K+/month by selling your expertise. Join 9 tech leaders in our January cohort. 2-week guarantee, flexible payment plans."
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-xs text-muted-foreground/60 mt-1">In January</p>
            </Card>
            <Card className="p-8 text-center hover:shadow-lg transition-shadow">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-500/10 to-red-600/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Join the January cohort and prove your offer works by hitting $10K+/month
          </p>
