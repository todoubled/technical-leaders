...
const AIProgramSelector = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-white dark:bg-gray-100 py-12 overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-white dark:from-gray-100 to-transparent z-10" />
          <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-white dark:from-gray-100 to-transparent z-10" />
